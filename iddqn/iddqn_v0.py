...
for b in BOARD_SIZES:
    ...
    with open(meta_csv, "w", newline="") as f:
        ...
        agents = [IDDQNAgent(obs_d, n_act) for _ in range(env.num_players)]
        ...
        while True:
            ...
            while not ts.last():
                ...
                act = agents[p].act(ts.observations["info_state"][p],
            ...
            if now >= next_snap:
                ...
                f.flush()
                agents[0].losses.clear()

                for i, ag in enumerate(agents):
                    torch.save(ag.online.state_dict(),
